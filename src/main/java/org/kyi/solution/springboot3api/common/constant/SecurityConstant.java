package org.kyi.solution.springboot3api.common.constant;
...
public class SecurityConstant {
    ...
    public static final String TOCOBEP_LLC = "KYI, LLC";
    public static final String TOCOBEP_ADMINISTRATION = "KYI ADMINISTRATION";
